...
// create a component
const ModalSetting: React.FC<ModalSettingProps> = ({ showSetting, onClose }) => {
            ...
            <View style={styles.modalOverlay}>
                <View style={styles.settingModalBox}>
                    ...
                    <View style={styles.settingIconRow}>
                        <TouchableOpacity style={styles.settingIconWrapper} onPress={() => setSoundEnabled(!soundEnabled)}>
                            <View style={[styles.settingCircle, { backgroundColor: soundEnabled ? '#7ED957' : '#CCCCCC' }]}>
                                <Text style={styles.settingCircleIcon}>🔊</Text>
                            </View>
                            <Text style={styles.settingIconLabel}>Sound</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.settingIconWrapper} onPress={() => setTheme(theme === Theme.Light ? Theme.Dark : Theme.Light)}>
                            <View style={[styles.settingCircle, { backgroundColor: theme === Theme.Dark ? '#1e1f1dff' : '#ffffffff' }]}>
                                <Text style={styles.settingCircleIcon}>🎨</Text>
                            </View>
                            <Text style={styles.settingIconLabel}>Theme</Text>
                        </TouchableOpacity>
                        {/* <TouchableOpacity style={styles.settingIconWrapper}>
                            <View style={[styles.settingCircle, { backgroundColor: '#7ED957' }]}>
                                <Text style={styles.settingCircleIcon}>❓</Text>
                            </View>
                            <Text style={styles.settingIconLabel}>Difficult</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.settingIconWrapper}>
                            <View style={[styles.settingCircle, { backgroundColor: '#7ED957' }]}>
                                <Text style={styles.settingCircleIcon}>❓</Text>
                            </View>
                            <Text style={styles.settingIconLabel}>Help</Text>
                        </TouchableOpacity> */}
